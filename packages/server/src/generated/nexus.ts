...
export interface NexusGenFieldTypes {
  ...
  Post: {
    // field return type
    author: NexusGenRootTypes['BaseUser'] | null; // BaseUser
    content: string | null; // String
    createdAt: NexusGenScalars['DateTime']; // DateTime!
    id: number; // Int!
    published: boolean; // Boolean!
